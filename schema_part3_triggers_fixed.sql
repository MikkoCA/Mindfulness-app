-- PART 3: TRIGGERS AND FUNCTIONS (FIXED)
-- ===========================================
...
-- Auto-create user settings for new users (with unique name)
DROP TRIGGER IF EXISTS mindfulness_app_user_created ON auth.users;
CREATE TRIGGER mindfulness_app_user_created
