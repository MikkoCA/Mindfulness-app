...
ALTER DATABASE postgres SET "authenticator" TO 'authenticator';
ALTER DATABASE postgres SET "authenticated" TO 'authenticated';
ALTER DATABASE postgres SET "service_role" TO 'service_role';
